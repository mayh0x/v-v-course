...
import java.net.URL;
public class AddprodutocomidaTest {
  ...
  public void addprodutocomida() {
    ...
    driver.findElement(By.cssSelector(".shadow:nth-child(3)")).sendKeys("Arroz");
    {
    ...
    driver.findElement(By.cssSelector(".mb-4:nth-child(4) > .shadow")).sendKeys("3");
    ...
    assertThat(driver.findElement(By.cssSelector(".whitespace-nowrap:nth-child(1)")).getText(), is("Arroz"));
    assertThat(driver.findElement(By.cssSelector(".capitalize")).getText(), is("Comida"));
    assertThat(driver.findElement(By.cssSelector(".whitespace-nowrap:nth-child(3)")).getText(), is("R$ 8.00"));
    assertThat(driver.findElement(By.cssSelector(".whitespace-nowrap:nth-child(4)")).getText(), is("3 un"));
